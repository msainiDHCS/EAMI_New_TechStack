...
{
    internal class ECSGeneratedFileValidator : ValidatorBase<List<IClaimpayment>, CommonStatus>
    {
        ...
        public ECSGeneratedFileValidator(int OrganizationID, string ClaimIdentifier)
