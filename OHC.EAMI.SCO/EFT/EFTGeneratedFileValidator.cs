...
{
    internal class EFTGeneratedFileValidator : ValidatorBase<List<IClaimpayment>, CommonStatus>
    {
        ...
        public EFTGeneratedFileValidator(int OrganizationID, string ClaimIdentifier)
