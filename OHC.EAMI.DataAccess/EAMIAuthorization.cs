...
{
    public class EAMIAuthorization : DataAccessBase
    {
        public EAMIAuthorization()
        {
        }
        ...
        public CommonStatusPayload<EAMIUser> GetEAMIUser(string userName, string domainName = null, string password = null, bool verifyPassword = false)
        {
            ...
            try
            {
                ...
                base.contextDb.LoadDataSet(DbStoredProcs.spGetEAMIUser, ds, tableNames, DbStoredProcs.GetEAMIUserParams(userName,domainName,password));
        ...
        public CommonStatusPayload<EAMIUser> GetEAMIUserByID(long userID)
        {
            ...
            try
            {
                ...
                base.contextDb.LoadDataSet("usp_GetEAMIUserByID", ds, tableNames, spparams);
        ...
        public CommonStatus DeactivateEAMIUser(EAMIUser inputUser, string loginUserName)
        {
            ...
            try
            {
                DbCommand cmd = base.contextDb.GetStoredProcCommand("usp_DeactivateEAMIUser");

                base.contextDb.AddInParameter(cmd, "UserID", DbType.Int64, inputUser.User_ID);               
                base.contextDb.AddInParameter(cmd, "IsActive", DbType.Boolean, 0);
                base.contextDb.AddInParameter(cmd, "LoginUserName", DbType.String, loginUserName);

                base.contextDb.AddOutParameter(cmd, "Status", DbType.String, 10);
                base.contextDb.AddOutParameter(cmd, "Message", DbType.String, -1);
        ...
        public CommonStatus GetActivestatusEAMIUserInfo(long inputUser )
        {
            ...
            try
            {           
                DbCommand cmd = base.contextDb.GetStoredProcCommand("usp_GetEAMIUserActiveInfo");
                base.contextDb.AddInParameter(cmd, "UserID", DbType.Int64, inputUser);
                base.contextDb.AddOutParameter(cmd, "Status", DbType.Boolean, 0);

                int cnt = base.contextDb.ExecuteNonQuery(cmd);

                bool isValid = Convert.ToBoolean(base.contextDb.GetParameterValue(cmd, "Status"));
        ...
        public CommonStatus AddUpdateEAMIUser(EAMIUser inputUser, string loginUserName)
        {
            ...
            try
            {
                DbCommand cmd = base.contextDb.GetStoredProcCommand("usp_AddUpdateEAMIUser");

                base.contextDb.AddInParameter(cmd, "UserID", DbType.Int64, inputUser.User_ID);
                base.contextDb.AddInParameter(cmd, "UserName", DbType.String, inputUser.User_Name);
                base.contextDb.AddInParameter(cmd, "DisplayName", DbType.String, inputUser.Display_Name);
                base.contextDb.AddInParameter(cmd, "UserEmailAddr", DbType.String, inputUser.User_EmailAddr);
                if (!string.IsNullOrWhiteSpace(inputUser.User_Password))
                    base.contextDb.AddInParameter(cmd, "UserPassword", DbType.String, EAMIHashGenerator.ComputeHash(inputUser.User_Password));
                else
                    base.contextDb.AddInParameter(cmd, "UserPassword", DbType.String, null);
                base.contextDb.AddInParameter(cmd, "DomainName", DbType.String, inputUser.Domain_Name);
                base.contextDb.AddInParameter(cmd, "UserTypeID", DbType.Int64, inputUser.User_Type.ID);
                base.contextDb.AddInParameter(cmd, "IsActive", DbType.Boolean, inputUser.IsActive);
        ...
        public CommonStatusPayload<List<Tuple<string, EAMIAuthBase>>> GetEAMIAuthorizationLookUps(string lookUpType = null)
        {
            ...
            try
            {
                using (var reader = base.contextDb.ExecuteReader(CommandType.StoredProcedure, "usp_GetEAMILookUps"))
                {
                    while (reader.Read())
                    {
        ...
        public CommonStatus CheckEAMIUserValidity(string userName, long userType)
        {
            ...
            try
            {
                DbCommand cmd = base.contextDb.GetStoredProcCommand("usp_CheckUserValidity");

                base.contextDb.AddInParameter(cmd, "UserName", DbType.String, userName);
                base.contextDb.AddInParameter(cmd, "UserTypeID", DbType.Int64, userType);
                base.contextDb.AddOutParameter(cmd, "Status", DbType.Boolean, 1);
        ...
        public CommonStatusPayload<List<EAMIUser>> GetAllEAMIUsers()
        {
            ...
            try
            {
                using (var reader = base.contextDb.ExecuteReader(CommandType.StoredProcedure, "usp_GetAllEAMIUsers"))
                {
                    while (reader.Read())
                    {
        ...
        public CommonStatus AddUpdateEAMIMasterData(EAMIMasterData inputData, string loginUserName)
        {
            ...
            try
            {
                DbCommand cmd = base.contextDb.GetStoredProcCommand("usp_AddUpdateDataByType");

                base.contextDb.AddInParameter(cmd, "Type", DbType.String, inputData.DataType);
                base.contextDb.AddInParameter(cmd, "ID", DbType.Int64, inputData.ID);
                base.contextDb.AddInParameter(cmd, "Code", DbType.String, inputData.Code);
                base.contextDb.AddInParameter(cmd, "Name", DbType.String, inputData.Name);

                base.contextDb.AddInParameter(cmd, "RA_Dept_Name", DbType.String, inputData.DepartmentName);
                base.contextDb.AddInParameter(cmd, "RA_ORG_Code", DbType.String, inputData.OrganizationCode);
                base.contextDb.AddInParameter(cmd, "RA_Dept_Add_LN", DbType.String, inputData.RADepartmentAddrLine);
                base.contextDb.AddInParameter(cmd, "RA_Dept_Add_CSZ", DbType.String, inputData.RADepartmentAddrCSZ);

                base.contextDb.AddInParameter(cmd, "RA_Inq_PH_No", DbType.String, inputData.RAInquiryPhNo);
                base.contextDb.AddInParameter(cmd, "FEIN_Number", DbType.String, inputData.FEIN_Number);

                base.contextDb.AddInParameter(cmd, "MAX_Pymt_Rec_Amt", DbType.String, inputData.MaxPmtRecAmt);
                base.contextDb.AddInParameter(cmd, "MAX_Pymt_Rec_Per_Tran", DbType.String, inputData.MaxPmtRecPerTran);

                base.contextDb.AddInParameter(cmd, "MAX_Funding_DTL_Per_Pymt_Rec", DbType.String, inputData.MaxFundingDtlPerPmtRec);
                base.contextDb.AddInParameter(cmd, "TRACE_Incoming_Pmt_Data", DbType.String, inputData.TraceIncomingPmtData);
                base.contextDb.AddInParameter(cmd, "Validate_Funding_Source", DbType.String, inputData.ValidateFundingSource);
                base.contextDb.AddInParameter(cmd, "Title_Transfer_Letter", DbType.String, inputData.TitleTransferLetter);
                base.contextDb.AddInParameter(cmd, "IsActive", DbType.Boolean, inputData.IsActive);
        ...
        public CommonStatusPayload<List<EAMIMasterData>> GetAllEAMIMasterData(string DataType)
        {
            ...
            try
            {
                ...
                base.contextDb.LoadDataSet(DbStoredProcs.spGetAllDataByType, ds, tableNames, DbStoredProcs.GetAllDataTypeParams(DataType));
        ...
        public CommonStatusPayload<EAMIMasterData> GetEAMIMasterDataByID(string DataType, long DataTID)
        {
            ...
            try
            {
                ...
                string[] tableNames = new string[] { "data" };
                base.contextDb.LoadDataSet(DbStoredProcs.spGetGivenDataByType, ds, tableNames, DbStoredProcs.GetGivenDataByTypeParams(DataType, DataTID));
        ...
        public CommonStatusPayload<List<Tuple<EAMIDateType, string, DateTime>>> GetYearlyCalendarEntries(int activeYear, string loginUserName)
        {
            ...
            try
            {
                ...
                base.contextDb.LoadDataSet("usp_GetCalendarByYear", ds, tableNames, spparams);
        ...
        public CommonStatus UpdateYearlyCalendarEntry(List<Tuple<EAMIDateType, EAMICalendarAction, string, DateTime>> dates, string loginUserName)
        {
            ...
            try
            {
                DbCommand cmd = base.contextDb.GetStoredProcCommand("usp_UpdateYearlyCalendarEntry");
