...
-- special (program specific) handling of this table (has to start with 10060001 value for Dental)
DELETE FROM TB_ECS_SEQUENCE
DBCC CHECKIDENT ('TB_ECS_SEQUENCE',RESEED, 10060001)
GO
...
VALUES
	('MDSDFFS', null, 1, 1, getdate(), 'system', null, null)     
GO
...
VALUES
	...
	-- SCO Claim ID
	('SCO_CLAIM_ID_FUND_0912_EFT', 'DHCSMCDEFT', 1, 'SCO Claim Identifier for fund 0912 EFT', 1, 0, getdate(), 'system', null, null),
	('SCO_CLAIM_ID_FUND_0555_EFT', 'DHCSMCDHFE', 1, 'SCO Claim Identifier for fund 0555 EFT', 1, 0, getdate(), 'system', null, null),
	('SCO_CLAIM_ID_FUND_0236_EFT', 'XXXXXXXXXX', 1, 'SCO Claim Identifier for fund 0236 EFT', 1, 0, getdate(), 'system', null, null),
	('SCO_CLAIM_ID_FUND_0001_EFT', 'DHCSMCDGFE', 1, 'SCO Claim Identifier for fund 0001 EFT', 1, 0, getdate(), 'system', null, null),

	-- ECS File Name
	('ECS_FILE_NAME_FUND_0912_PROD', 'D{0}.MCDE.INPUT', 1, 'ECS Prod file name for fund 0912', 1, 0, getdate(), 'system', null, null),
	('ECS_FILE_NAME_FUND_0555_PROD', 'D{0}.MCDH.INPUT', 1, 'ECS Prod file name for fund 0555', 1, 0, getdate(), 'system', null, null),
	('ECS_FILE_NAME_FUND_0001_PROD', 'D{0}.MCDG.INPUT', 1, 'ECS Prod file name for fund 0001', 1, 0, getdate(), 'system', null, null),
	('ECS_FILE_NAME_FUND_0912_TEST', 'D{0}.MCDE.WARRANT', 1, 'ECS Test file name for fund 0912', 1, 0, getdate(), 'system', null, null),
	('ECS_FILE_NAME_FUND_0555_TEST', 'D{0}.MCDH.WARRANT', 1, 'ECS Test file name for fund 0555', 1, 0, getdate(), 'system', null, null),
	('ECS_FILE_NAME_FUND_0001_TEST', 'D{0}.MCDG.WARRANT', 1, 'ECS Test file name for fund 0001', 1, 0, getdate(), 'system', null, null),
		
	-- EFT File Name
	('EFT_FILE_NAME_FUND_0912_PROD', 'D{0}.MCDE.INPUT', 1, 'EFT Prod file name for fund 0912', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0555_PROD', 'D{0}.MCDH.INPUT', 1, 'EFT Prod file name for fund 0555', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0236_PROD', 'D{0}.MCDT.INPUT', 1, 'EFT Prod file name for fund 0236', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0001_PROD', 'D{0}.MCDG.INPUT', 1, 'EFT Prod file name for fund 0001', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0912_TEST', 'D{0}.MCDE.EFT', 1, 'EFT Test file name for fund 0912', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0555_TEST', 'D{0}.MCDH.EFT', 1, 'EFT Test file name for fund 0555', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0236_TEST', 'D{0}.MCDT.EFT', 1, 'EFT Test file name for fund 0236', 1, 0, getdate(), 'system', null, null),
	('EFT_FILE_NAME_FUND_0001_TEST', 'D{0}.MCDG.EFT', 1, 'EFT Test file name for fund 0001', 1, 0, getdate(), 'system', null, null)
...
VALUES
	...
	('PCFH', 'Payment Type associated with fund 0001', 0, 3, getdate(), 'SYSTEM', NULL, NULL),
	('EWC', 'Payment Type associated with fund 0236', 0, 4, getdate(), 'SYSTEM', NULL, NULL),
	('GF', 'Payment Type associated with fund 0001', 1, 5, getdate(), 'SYSTEM', NULL, NULL)
GO
...
INSERT INTO [dbo].[TB_SYSTEM]
    ...
    ,[UpdatedBy])
VALUES
	('MDSDFFS', 'MDSDFFS', 1, 1, getdate(), 'SYSTEM', NULL, NULL)
GO
